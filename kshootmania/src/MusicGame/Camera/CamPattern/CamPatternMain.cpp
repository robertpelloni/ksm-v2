...
namespace MusicGame::Camera
{
	...
	bool CamPatternMain::hasSwingEvent(kson::Pulse laserSlamPulse, int32 direction) const
	{
		return m_swing.hasEvent(laserSlamPulse, direction);
	}
}
